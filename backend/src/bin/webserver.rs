...
fn build_mock_plants() -> impl Iterator<Item = NativePlant> {
    vec![
        NativePlant {
            ...
            bloom: Some("Spring to early summer".to_string()),
        ...
        NativePlant {
            ...
            bloom: Some("Late summer to fall".to_string()),
            description: Some("This plant is a favorite of hummingbirds and supports the Columbine Duskywing butterfly caterpillar.".to_string()),
        ...
        NativePlant {
            ...
            bloom: Some("Late spring to early summer".to_string()),
            description: Some("This plant is a favorite of hummingbirds and supports the Columbine Duskywing butterfly caterpillar.".to_string()),
        ...
        NativePlant {
            ...
            bloom: Some("Late summer to early fall".to_string()),
            description: Some("This plant is a favorite of hummingbirds and supports the Columbine Duskywing butterfly caterpillar.".to_string()),
