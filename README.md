...
1. [Data gathering](data/), which gathers information about plants via sources like 
   USDA and wildflower.org. As a last resort, some information comes from LLMs.
2. [Frontend](frontend/www/), the user facing React application.
3. [Backend](backend/), a Rust backend which connects the frontend to the gathered data.
